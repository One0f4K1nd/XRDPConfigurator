...
"}")
        ...
        self.x11rdpParamsLineEdit = QLineEdit(self.x11rdpGroupBox)
        self.x11rdpParamsLineEdit.setObjectName(u"x11rdpParamsLineEdit")
        self.x11rdpParamsLineEdit.setGeometry(QRect(6, 26, 539, 27))
        self.x11rdpParamsLineEdit.setAutoFillBackground(False)
...
#if QT_CONFIG(tooltip)
        self.x11rdpParamsLineEdit.setToolTip(QCoreApplication.translate("XRDPConfigurator", u"<html><head/><body><p>These are the parameters used when xrdp-sesman starts an X11rdp back-end X server.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
